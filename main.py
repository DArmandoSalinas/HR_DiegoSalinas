...
while True:
    ...
    if choice == "1":
        ...
        #features.duplicated(subset=None, keep=False)
        ...
        for participant in unique_participants:
            for stimulus in unique_stimuli:
                ...
                # Select data for the current participant and stimul
...
# Draw horizontal line at y=0
                ax.hlines(0, xmin=-1, xmax=1, linestyles="dashed")

# Draw vertical line at x=0
                ax.vlines(0, ymin=-1, ymax=1, linestyles="dashed")
